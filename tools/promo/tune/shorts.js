/*
 * The TikTok cuts: twelve 9:16 edits of the tutorial's footage, each built
...
export const SHORTS = [
  ...
  {
    id: 'free-look',
    num: 10, // 8 and 9 are the two screen recordings (tools/promo/film)
    title: 'See what it would change before you pay',
    dur: 20,
    cover: 1.6,
    shots: [
      { a: 0, b: 2, src: 30.4, pointer: false },
      { a: 2, b: 6, src: [28.6, 0.45], pointer: false },
      { a: 6, b: 10, src: 30.4, pointer: false },
      { a: 10, b: 14, src: 58.9, pointer: false },
      { a: 14, b: 20, src: 58.9, pointer: false },
    ],
    cam: [
      { t: 0, to: { key: 'pc', s: 2.0, dy: -60 } },
      { a: 0, b: 2, to: { key: 'pc', s: 2.12, dy: -60 }, e: 'io' },
      { t: 2, to: { key: 'pc', s: 1.9, dy: 140 } },
      { a: 2, b: 6, to: { key: 'pc', s: 1.98, dy: 140 }, e: 'io' },
      { t: 6, to: { key: 'run', s: 1.9, dy: 60 } },
      { a: 6, b: 10, to: { key: 'run', s: 2.0, dy: 60 }, e: 'io' },
      { t: 10, to: { key: 'bios.1', s: 1.22, dy: 80 } },
      { a: 10, b: 14, to: { key: 'bios.1', s: 1.32, dy: 80 }, e: 'io' },
    ],
    whips: [{ t: 6, axis: 'x', dir: 1 }, { t: 10, axis: 'x', dir: -1 }],
    punches: [2, 6, 10, 14, 17],
    hook: { a: 0, b: 2, text: 'See what it would change|*before you pay.*' },
    caps: [
      { a: 2.05, b: 4, text: 'It *reads your PC* first: CPU, GPU, RAM, the board.' },
      { a: 4, b: 6, text: 'Laptop, Wi-Fi, controller: *the safe bar is yours.*' },
      { a: 6.05, b: 8, text: 'Then the *free report*.' },
      { a: 8, b: 10, text: 'Everything it would cut. *It changes nothing.*' },
      { a: 10.1, b: 12, text: 'Plus a *BIOS checklist* for your board.' },
      { a: 12, b: 14, text: 'Most PCs have *free speed* sitting in there.' },
    ],
    boxes: [
      { a: 0.25, b: 2, sel: '#c-pc', label: 'Example PC' },
      { a: 6.2, b: 10, sel: '#b-report' },
    ],
    dims: [[10.6, 14, 0.5], [14, 20, 0.66]],
    cards: [
      { type: 'quote', a: 10.6, b: 14, k: 'From the free report · BIOS checklist', text: '2. Re-Size BAR / Smart Access Memory: set Above 4G Decoding = Enabled, then *Re-Size BAR Support = Auto/Enabled.*' },
      { type: 'cmd', a: 14, b: 17, title: 'The free report', lines: ["$env:OMNIDX_MODE='report'", 'irm omnidx.net/go.ps1 | iex'] },
      { ...END(['Free. *No key needed.*', 'Try it before you pay', '*omnidx.net*']), a: 17, b: 20 },
    ],
    chips: { ex: [[0.3, 14]] },
  },

  {
    id: 'keep-discord',
    num: 11,
    title: 'Will it break my Discord?',
    dur: 20,
    cover: 1.6,
    shots: [
      { a: 0, b: 2, src: 31.8, pointer: false },
      { a: 2, b: 6, src: [31.8, 0.5] },
      { a: 6, b: 12, src: 43.7, pointer: false },
      { a: 12, b: 16, src: 46.7, pointer: false },
      { a: 16, b: 20, src: 46.7, pointer: false },
    ],
    cam: [
      { t: 0, to: { key: 'discord', s: 2.3, dx: 60 } },
      { a: 0, b: 2, to: { key: 'discord', s: 2.45, dx: 60 }, e: 'io' },
      { t: 2, to: { key: 'discord', s: 1.9, dx: 60, dy: 60 } },
      { a: 2, b: 6, to: { key: 'discord', s: 1.98, dx: 60, dy: 60 }, e: 'io' },
      { t: 6, to: { key: 'log', s: 1.9, dx: -258, dy: 77 } },
      { a: 6, b: 12, to: { key: 'log', s: 1.98, dx: -255, dy: 80 }, e: 'io' },
      { t: 12, to: { key: 'count', s: 2.0, dy: 40 } },
    ],
    whips: [{ t: 6, axis: 'y', dir: -1 }, { t: 12, axis: 'x', dir: 1 }],
    punches: [2, 4, 6, 9, 12, 16],
    hook: { a: 0, b: 2, text: 'Will it break|*my Discord?*' },
    caps: [
      { a: 2.05, b: 4, text: 'Everything that starts with Windows is *a tick box*.' },
      { a: 4, b: 6, text: 'Untick what you want. *Discord stays.*' },
      { a: 6.1, b: 9, text: 'It even turns on its *hardware acceleration*.' },
      { a: 9, b: 12, text: 'Spotify: no auto-start. *Still opens when you click it.*' },
      { a: 12.1, b: 16, text: 'Everything else: *off at startup, still installed.*' },
    ],
    boxes: [
      { a: 0.3, b: 2, sel: '#su-0', label: 'Example PC' },
      { a: 3.3, b: 6, sel: '#su-0' },
      { a: 6.4, b: 12, text: ['#logbox div', 'Discord: hardware acceleration on'] },
    ],
    dims: [[16, 20, 0.66]],
    cards: [
      { ...END(['What would *you* keep?', 'Comment the app', '*omnidx.net*']), a: 16, b: 20 },
    ],
    chips: { ex: [[0.3, 16]] },
  },

  {
    id: 'checks-itself',
    num: 12,
    title: 'Never paste a random command',
    dur: 22,
    cover: 1.6,
    shots: [
      { a: 0, b: 2, src: 19.6, pointer: false },
      { a: 2, b: 4, src: [19.6, 1.2], pointer: false },
      { a: 4, b: 6, src: [23.0, 1.0] },
      { a: 6, b: 12, src: 24.9, pointer: false },
      { a: 12, b: 22, src: 63.8, pointer: false },
    ],
    cam: [
      { t: 0, to: { key: 'prompt', s: 2.45, dx: -25 } },
      { a: 0, b: 2, to: { key: 'prompt', s: 2.55, dx: -25 }, e: 'io' },
      { t: 2, to: { key: 'prompt', s: 2.45, dx: -25 } },
      { t: 4, to: { cx: 960, cy: 620, s: 1.85 } },
      { t: 6, to: { key: 'verify', s: 1.35 } },
      { a: 6, b: 12, to: { key: 'verify', s: 1.5 }, e: 'io' },
    ],
    whips: [{ t: 4, axis: 'y', dir: -1 }, { t: 12, axis: 'x', dir: 1 }],
    punches: [2, 4, 6, 9, 12, 18],
    hook: { a: 0, b: 2, text: 'Never paste a random command|*from the internet.*' },
    caps: [
      { a: 2.05, b: 4, text: 'Unless it *checks itself*.' },
      { a: 4.05, b: 6, text: 'Windows asks first. *Yes.*' },
      { a: 6.1, b: 9, text: "It compares the script's *fingerprint* (sha256)" },
      { a: 9, b: 12, text: 'with the copy the *Windows check tested*. One byte off: *it refuses.*' },
      { a: 12.1, b: 15, text: 'Every line is *public*.' },
      { a: 15, b: 18, text: 'Read it *before you pay*.' },
    ],
    keys: [{ t: 3.65, keys: ['Enter'], until: 4.2 }],
    boxes: [{ a: 6.3, b: 7.6, text: ['#admin-text span', 'Script verified'] }],
    dims: [[7.6, 12, 0.5], [12, 22, 0.7]],
    cards: [
      { type: 'quote', a: 7.6, b: 12, k: 'What the script prints before it runs', text: 'Script verified: sha256 7c41d09e5b2a... *matches the copy the Windows check tested* (v1.77.0).' },
      { type: 'code', a: 12, b: 18 },
      { ...END(['*Read it* before you run it.', 'omnidx.net/tune/omnidx.ps1', '*omnidx.net*']), a: 18, b: 22 },
    ],
    chips: {},
  },

  {
    id: 'one-payment',
    num: 13,
    title: 'PC optimizers want a monthly fee',
    dur: 20,
    cover: 1.6,
    shots: [
      { a: 0, b: 2, src: 46.7, pointer: false },
      { a: 2, b: 8, src: [36.0, 1.7] },
      { a: 8, b: 12, src: 46.7, pointer: false },
      { a: 12, b: 16, src: [60.2, 0.6] },
      { a: 16, b: 20, src: 63.8, pointer: false },
    ],
    cam: [
      { t: 0, to: { key: 'count', s: 2.3, dy: 40 } },
      { a: 0, b: 2, to: { key: 'count', s: 2.45, dy: 40 }, e: 'io' },
      { t: 2, to: { key: 'log', s: 1.9, dx: -258, dy: 77 } },
      { a: 2.2, b: 8, to: { key: 'log', s: 1.98, dx: -255, dy: 80 }, e: 'io' },
      { t: 8, to: { key: 'count', s: 1.9, dy: 40 } },
      { t: 12, to: { key: 'undo', s: 2.0, dx: -110, dy: 110 } },
      { a: 12, b: 16, to: { key: 'undo', s: 2.08, dx: -110, dy: 110 }, e: 'io' },
    ],
    whips: [{ t: 2, axis: 'y', dir: -1 }, { t: 12, axis: 'x', dir: 1 }],
    punches: [2, 5, 8, 12, 16],
    hook: { a: 0, b: 2, text: 'PC optimizers want|*a monthly fee.*' },
    caps: [
      { a: 2.05, b: 5, text: 'This one: *$19.99. Once.*' },
      { a: 5, b: 8, text: 'Every future version *free*. Same command, newest script.' },
      { a: 12.1, b: 14, text: '*Undo included.*' },
      { a: 14, b: 16, text: '*OmniDx Edition* included.' },
    ],
    boxes: [{ a: 12.4, b: 16, sel: '#b-undo' }],
    dims: [[8, 12, 0.6], [16, 20, 0.66]],
    cards: [
      { type: 'count', a: 8, b: 12, from: 214, to: 86 },
      { ...END(['*No subscription.* Ever.', 'Squad: 3 keys, *$39.99*', '*omnidx.net*']), a: 16, b: 20 },
    ],
    chips: { ex: [[0.3, 16]], ff: [[2.2, 8]] },
  },

  {
    id: 'reads-first',
    num: 14,
    title: 'It reads your PC before it cuts anything',
    dur: 22,
    cover: 1.6,
    shots: [
      { a: 0, b: 2, src: 31.0, pointer: false },
      { a: 2, b: 8, src: [28.4, 0.55], pointer: false },
      { a: 8, b: 14, src: 31.0, pointer: false },
      { a: 14, b: 18, src: 58.95, pointer: false },
      { a: 18, b: 22, src: 58.95, pointer: false },
    ],
    cam: [
      { t: 0, to: { key: 'pc', s: 2.0, dy: -60 } },
      { a: 0, b: 2, to: { key: 'pc', s: 2.12, dy: -60 }, e: 'io' },
      { t: 2, to: { key: 'pc', s: 1.9, dy: 140 } },
      { a: 2, b: 8, to: { key: 'pc', s: 1.98, dy: 140 }, e: 'io' },
      { t: 8, to: { key: 'pc', s: 2.3, dx: -40, dy: 230 } },
      { a: 8, b: 14, to: { key: 'pc', s: 2.38, dx: -40, dy: 230 }, e: 'io' },
      { t: 14, to: { key: 'bios.4', s: 1.22, dy: 90 } },
      { a: 14, b: 18, to: { key: 'bios.4', s: 1.3, dy: 90 }, e: 'io' },
    ],
    whips: [{ t: 8, axis: 'y', dir: 1 }, { t: 14, axis: 'x', dir: -1 }],
    punches: [2, 5, 8, 11, 14, 18],
    hook: { a: 0, b: 2, text: 'It reads your PC|*before it cuts anything.*' },
    caps: [
      { a: 2.05, b: 5, text: 'CPU, GPU, RAM, the board, *laptop or desktop*.' },
      { a: 5, b: 8, text: 'Wi-Fi, controller, printer: *it keeps what you use.*' },
      { a: 8.1, b: 11, text: 'It even spots *RAM running slow*.' },
      { a: 11, b: 14, text: '*Security stays on*: Secure Boot, TPM, memory integrity.' },
      { a: 14.1, b: 18, text: 'Then a BIOS checklist for *your exact board*.' },
    ],
    boxes: [
      { a: 0.3, b: 2, sel: '#c-pc', label: 'Example PC' },
      { a: 5.2, b: 8, text: ['#a-mt div', 'Keeps:'] },
      { a: 8.2, b: 11, sel: '#a-adv', clip: '#c-pc' },
      { a: 11.1, b: 14, text: ['#a-mt div', 'Secure Boot'] },
    ],
    dims: [[14.6, 18, 0.5], [18, 22, 0.66]],
    cards: [
      { type: 'quote', a: 14.6, b: 18, k: 'From the report · BIOS checklist', text: 'How to get in: restart, then press *Del* while the *MSI logo* shows. 1. Memory profile: enable *EXPO*.' },
      { ...END(['*Your* PC. *Your* safe bar.', 'Free report first', '*omnidx.net*']), a: 18, b: 22 },
    ],
    chips: { ex: [[0.3, 18]] },
  },
];
