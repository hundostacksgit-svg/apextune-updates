...
export const MENUS = [
  ...
  },
  {
    id: 'clip', label: 'Clip', items: [
      ...
      { label: 'Set a transition…', when: () => api.hasSelection?.(), run: () => api.openPanel?.('transitions') },
      { sep: true },
  ...
  },
  {
    id: 'timeline', label: 'Timeline', items: [
      ...
      { label: 'Add a null object', run: () => api.addNull?.() },
  ...
  },
  {
    id: 'view', label: 'View', items: [
      ...
      { label: 'Overlays', key: '7', run: () => api.openPanel?.('overlays') },
