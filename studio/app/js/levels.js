...
export const DESCRIPTIONS = {
  beginner: {
    name: 'Beginner',
    tag: 'Guided',
    line: 'Fourteen tabs and a guided path. Nothing on screen that you do not need yet.',
    shows: ['Media', 'AI editor', 'Filters, transitions, overlays, stickers and sound as their own tabs', 'Text with 49 styles and 35 animations', 'Music', 'Export presets'],
  },
  intermediate: {
    name: 'Intermediate',
    tag: 'Editing',
  ...
  expert: {
    ...
    shows: ['Serial correctors — a real node chain, each one keying the last one\u2019s output',
      ...
      'Split screen against the ungraded shot, on a line you drag',
      'The Motion page, plus the lightbox for matching a sequence',
      'Stills gallery: grab a grade, drop it on the next shot',
      'Copy and paste attributes across a whole selection, as one undo',
