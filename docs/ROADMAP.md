...
| 3 | Undervolt-not-overclock and frame-cap notes per vendor in the report, and a guide page | **1.75.0**; **live: `studio/undervolt/`** |
...
| 6 | A fresh-install answer file made in the browser: local account, OOBE screens skipped, telemetry minimal, the free look at first sign-in | **live: `studio/fresh/`** |
| 7 | A page on what custom Windows builds change and where the tune stops, without names | **live: `studio/builds/`** |
| 8 | The front page shows what a buyer gets as a slideshow, and every new feature is advertised | **live: the tour, `studio/#tour`** |
